...
* Running ralph in a container
  ...
  async def ralph(
      ...
      ctr = ctr.with_new_file(
          "/tmp/ralph-wrapper.sh", _RALPH_WRAPPER_SH,
      ).with_env_variable(
          "WORK_DIR", work_dir,
      ).with_env_variable(
...
chain:
  ...
  #+RESULTS[b63eaf17944fab7eebf8678cf2d16c197d921765]: ralph_yml_valid
  :results:
  ...
  #+RESULTS[8f3b1dcf87e5e221ea3d68d9781e03f6d8d12e96]:
  : work.start
  : 2
  :end:
