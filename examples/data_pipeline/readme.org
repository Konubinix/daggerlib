...
: Initialized module data_pipeline in /work/examples/data_pipeline
...
#+begin_src python :tangle .dagger/src/data_pipeline/main.py :noweb yes
...
* Running the transform in a clean environment
  ...
  #+RESULTS[d97d6207421120fdf4e4c5ff47cc775217a68443]: python_transform
  : name,email
  : ALICE,alice@example.com
  : BOB,bob@example.com
...
* Adding requests for the SFTP client wrapper
  ...
  #+RESULTS[27d55bd6a5acdf96e466201444827416f908a2b3]: venv_with_packages
  : 2.34.2
...
* Switching to Debian for native database drivers
  ...
  #+RESULTS[fa638d0e29405bbddd8a320e6ec259d2d8ba478b]: debian_transform
  : name,email
  : ALICE,alice@example.com
  : BOB,bob@example.com
...
requests
  ...
  #+RESULTS[fa62b3b70fac9d5ca97310ff75bfb2d6e7621636]: pip_compile
  : #
